...
class _PaymentScreenState extends State<PaymentScreen> {
  ...
  Future<void> getProduct() async{
    ...
    var response = await http.get(Uri.parse('http://192.168.102.75:3000/api/product'),
    headers: {
    ...
    Widget paymentButton = Container(
      ...
      child: ElevatedButton(
          ...
          onPressed: selected ? () async {
              var token = prefs.getString('token');
              var response = await http.post(Uri.parse('http://192.168.102.75:3000/api/transaction/buy'),
              headers: {
