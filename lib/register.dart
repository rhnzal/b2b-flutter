    ...
    Widget regPassword = Container(
      ...
      child: TextFormField(
        ...
        decoration: InputDecoration(
          ...
          }, icon: Icon(_regpass? Icons.visibility_outlined : Icons.visibility_off_outlined, color: Colors.white,), splashColor: Colors.transparent, highlightColor: Colors.transparent,)
          // prefixIcon: Padding(padding: EdgeInsets.fromLTRB(20, 10, 20, 10),
          //   child: Icon(Icons.),
          // )
        ),
    ...
    Widget confirmPassword = Container(
      ...
      child: TextFormField(
        ...
        decoration: InputDecoration(
          ...
          }, icon: Icon(_conpass? Icons.visibility_outlined : Icons.visibility_off_outlined, color: Colors.white,), splashColor: Colors.transparent, highlightColor: Colors.transparent,)
          // prefixIcon: Padding(padding: EdgeInsets.fromLTRB(20, 10, 20, 10),
          //   child: Icon(Icons.),
          // )
        ),
